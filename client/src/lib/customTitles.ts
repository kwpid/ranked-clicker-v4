...
export const CUSTOM_TITLES: CustomTitle[] = [
  ...
  {
    id: "rccs_s1_1v1_regional_contender",
    name: "RCCS S1 1V1 REGIONAL CONTENDER",
    type: "Custom",
    description: "Finish top 16 in a RCCS Regional 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_regional_finalist",
    name: "RCCS S1 1V1 REGIONAL FINALIST",
    type: "Custom",
    description: "Finish top 6 in a RCCS Regional 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_regional_champion",
    name: "RCCS S1 1V1 REGIONAL CHAMPION",
    type: "Custom",
    description: "Finish top 1 in a RCCS Regional 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_major_contender",
    name: "RCCS S1 1V1 MAJOR CONTENDER",
    type: "Custom",
    description: "Finish top 16 in a RCCS Major 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_major_finalist",
    name: "RCCS S1 1V1 MAJOR FINALIST",
    type: "Custom",
    description: "Finish top 6 in a RCCS Major 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_major_champion",
    name: "RCCS S1 1V1 MAJOR CHAMPION",
    type: "Custom",
    description: "Finish top 1 in a RCCS Major 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_worlds_contender",
    name: "RCCS S1 1V1 WORLDS CONTENDER",
    type: "Custom",
    description: "Finish top 6 in RCCS Worlds (1v1)",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_worlds_finalist",
    name: "RCCS S1 1V1 WORLDS FINALIIST",
    type: "Custom",
    description: "Finish top 4 in RCCS Worlds 1v1",
    color: "text-cyan-400",
    glow: "title-glow-aqua",
    unlocked: true,
    owned: false,
  ...
  {
    id: "rccs_s1_1v1_champion",
    name: "RCCS S1 1V1 CHAMPION",
    type: "Custom",
    description: "Won RCCS Season 1 (1v1)",
    color: "text-yellow-400",
    glow: "title-glow-golden",
    unlocked: false,
    owned: false,
